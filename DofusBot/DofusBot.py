...
# def mapswitch(farm_circle_key):
    # # time.sleep(gathering_time)
    # if farm_circle.get(farm_circle_key)[1] == 'LEFT':
    #     goLeft()
    # if farm_circle.get(farm_circle_key)[1] == 'RIGHT':
    #     goRight()
    # if farm_circle.get(farm_circle_key)[1] == 'UP':
    #     goUp()
    # if farm_circle.get(farm_circle_key)[1] == 'DOWN':
    #     goDown()
    # mapChanged = False
    # current_time = time.time()
    # time_dif = current_time - start_time
    # while time_dif < 6:
    #     if locateImg('LoadingMap.png', )
    # if (mapChanged):
    #     if farm_circle_key != 29:
    #         farm_circle_key += 1
    #     else:
    #         farm_circle_key = 0

    # print(farm_circle_key)
